namespace GameSettingsParser.Services.Progress
{
    ...
    public interface IProgressDialogService
    {
        ...
        /// Executes a non-cancellable task that reports progress.
        /// </summary>
        void Execute(Action<IProgress<double>> action, ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a non-cancellable task that reports progress.
        /// </summary>
        void Execute(Action<IProgress<string>, IProgress<double>> action, ProgressDialogOptions options);
        ...
        /// Executes a cancellable task that reports progress.
        /// </summary>
        void Execute(Action<CancellationToken, IProgress<double>> action,
                     ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a cancellable task that reports progress.
        /// </summary>
        void Execute(Action<CancellationToken, IProgress<string>, IProgress<double>> action,
                     ProgressDialogOptions options);
        ...
        /// Executes a non-cancellable task that reports progress and returns a value.
        /// </summary>
        bool TryExecute<T>(Func<IProgress<double>, T> action,
                           ProgressDialogOptions options, out T result);
        
        /// <summary>
        /// Executes a non-cancellable task that reports progress and returns a value.
        /// </summary>
        bool TryExecute<T>(Func<IProgress<string>, IProgress<double>, T> action,
                           ProgressDialogOptions options, out T result);
        ...
        /// Executes a cancellable task that reports progress and returns a value.
        /// </summary>
        bool TryExecute<T>(Func<CancellationToken, IProgress<double>, T> action,
                           ProgressDialogOptions options, out T result);
        
        /// <summary>
        /// Executes a cancellable task that reports progress and returns a value.
        /// </summary>
        bool TryExecute<T>(Func<CancellationToken, IProgress<string>, IProgress<double>, T> action,
                           ProgressDialogOptions options, out T result);
        ...
        /// Executes a non-cancellable async task that reports progress.
        /// </summary>
        Task ExecuteAsync(Func<IProgress<double>, Task> action, ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a non-cancellable async task that reports progress.
        /// </summary>
        Task ExecuteAsync(Func<IProgress<string>, IProgress<double>, Task> action, ProgressDialogOptions options);
        ...
        /// Executes a cancellable async task that reports progress.
        /// </summary>
        Task ExecuteAsync(Func<CancellationToken, IProgress<double>, Task> action,
            ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a cancellable async task that reports progress.
        /// </summary>
        Task ExecuteAsync(Func<CancellationToken, IProgress<string>, IProgress<double>, Task> action,
            ProgressDialogOptions options);
        ...
        /// Executes a non-cancellable async task that reports progress and returns a value.
        /// </summary>
        Task<T> ExecuteAsync<T>(Func<IProgress<double>, Task<T>> action, ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a non-cancellable async task that reports progress and returns a value.
        /// </summary>
        Task<T> ExecuteAsync<T>(Func<IProgress<string>, IProgress<double>, Task<T>> action, ProgressDialogOptions options);
        ...
        /// Executes a cancellable async task that reports progress and returns a value.
        /// </summary>
        Task<T> ExecuteAsync<T>(Func<CancellationToken, IProgress<double>, Task<T>> action,
            ProgressDialogOptions options);
        
        /// <summary>
        /// Executes a cancellable async task that reports progress and returns a value.
        /// </summary>
        Task<T> ExecuteAsync<T>(Func<CancellationToken, IProgress<string>, IProgress<double>, Task<T>> action,
            ProgressDialogOptions options);
    }
}